...
float I;
float D;
PID myPID(&Input, &Output, &Setpoint, 1, 0, 0, REVERSE);//pid///////////////
Servo servo_1;
Servo servo_2;
float psi, theta, phi;
...
void setup() {
  ...
  File dataFile = SD.open("328pm.txt", FILE_WRITE);
...
void loop() {
  ...
  dataFile = SD.open("328pm.txt", FILE_WRITE);
...
void actuate(){
  File dataFile = SD.open("328pm.txt", FILE_WRITE);
  double servoOutput = map(Output, -400, 400, 60, 120);////////////////////Set servo constraint here
  servo_1.write(servoOutput);////////////////////////////////////////////////////Tweak with calibration
  servo_2.write(servoOutput);////////////////////////////////////////////////////Tweak with calibration
  Serial.print("; Servo Output: ");
  Serial.println(servoOutput);
  dataFile.print("Time : ");
  dataFile.print(now);
  dataFile.print(" :Servo Output: ");
  dataFile.println(servoOutput);
  dataFile.close();
}
